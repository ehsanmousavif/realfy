    ...
    <div className="mt-30 mx-auto flex flex-col items-center justify-center gap-8 px-4 w-full">
      ...
      <div className="max-w-3xl mx-auto mt-6 px-4">
        <div className="flex flex-wrap justify-center gap-3 sm:gap-4">
          ...
          <div className="flex items-center gap-3 bg-background border border-foreground/10 py-2 px-5 rounded-xl w-full sm:w-auto justify-between sm:justify-start">
      ...
      <div className="relative aspect-video w-full flex flex-col gap-4">
        ...
        <Image
          ...
          fill
          className="block md:hidden object-contain mt-20"
        />
      </div>
    </div>
  );
